#!/bin/bash
# CMT ZIVPN PRO - LIVE CLOCK & RAINBOW EDITON
set -euo pipefail
...
<head>
    ...
    <style>
        ...
        .delete-btn { color: #ff4444; background: none; border: none; font-size: 1.2em; transition: 0.3s; }
...
{% else %}
    ...
    <div class="container">
        ...
        <div class="grid-menu">
            ...
            <div class="grid-box" style="border-color:var(--green);"><div style="font-size:0.7em;">Online</div><div class="grid-val" style="color:var(--green);">{{ active_count }}</div>
